  ...
  return (
    <div className="navbar bg-base-100 w-[95%] mx-auto">
      ...
      <div className="navbar-end gap-3 p-5">
        <button className="btn btn-active btn-success bg-[#23BE0A] hover:bg-[#1da108] text-white text-xl">Sign In</button>
        <button className="btn btn-active btn-accent bg-[#0077b6] hover:bg-[#1a659e] text-xl text-white">Sign Up</button>
      </div>
    </div>
  )
}
